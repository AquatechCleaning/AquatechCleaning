      ...
      <div className="ui-container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: "580px" }}>
          ...
          <div className="reveal-up reveal-up-d3 hero-actions" style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <a href={siteConfig.whatsapp} target="_blank" rel="noopener noreferrer" className="ui-btn" style={{ padding: "14px 28px", fontSize: "15px", background: "#25D366", color: "#fff", gap: "8px" }}>
